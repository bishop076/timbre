 ...
 * 200×200 and fails below it with a bare "Video unavailable", which is what
 * actually broke this app once. So hiding clips the panel
...
export function NowPlayingPanel() {
   ...
   * "Video unavailable". Expanded, this box is
