      ...
      playerRef.current = new YT.Player(host, {
        ...
        events: {
          ...
          onError: (event: { data: number }) => {
             ...
             *
             * That is the rule, and it is the reason that investigation
             ...
             * YouTube's 200×200 minimum and an upload that bars embedding
             * — both surfaced as the same confident sentence about the
