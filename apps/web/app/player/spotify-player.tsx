 ...
 * embed *is* controllable, the earlier notes are wrong where they
 ...
 * being plain that the previous behaviour was not an accident of the API. The argument was that
 ...
 * into browser settings for a problem a single press would fix. This is the same mistake
