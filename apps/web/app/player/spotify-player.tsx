...
// The earlier mistake inverted, session-wide state scoped to a single attempt. The ones that can
...
export function SpotifyPlayer({
  ...
  useEffect(() => {
    ...
    // exactly what happened, or an extension — left the track on `loading` for ever and the
