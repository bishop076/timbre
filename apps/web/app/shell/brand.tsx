...
/**
 * The palm, at its own aspect. Sized by height alone; the viewBox supplies the width, which
 * is why nothing here sets one — a square box would letterbox a mark that is 247×282.
 *
