...
/**
 * Charts — columns of differing height.
 *
 * Not a compass (that is Explore) and not a musical note: the tab leads to
 * rankings and graphs, and the glyph says so at a glance.
 */
