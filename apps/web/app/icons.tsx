...
function iconSet(svg: SVGProps<SVGSVGElement>) {
  return (...children: ReactElement[]) =>
    function Icon({ className }: { className?: string }) {
      return createElement("svg", { ...svg, className }, ...children);
    };
}

const stroked = iconSet({
  viewBox: "0 0 24 24",
  fill: "none",
  stroke: "currentColor",
  strokeWidth: 2,
...
const filled = iconSet({ viewBox: "0 0 24 24", fill: "currentColor", "aria-hidden": true });
...
export const SearchIcon = stroked(<circle cx="11" cy="11" r="7" />, <path d="m20 20-3.5-3.5" />);
...
export const ExternalIcon = stroked(
  <path d="M14 4h6v6" />,
  <path d="M20 4 11 13" />,
  <path d="M18 14v5a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V7a1 1 0 0 1 1-1h5" />,
);

export const NoteIcon = filled(
...
export const HomeIcon = stroked(
  <path d="M3.5 10.5 12 3.5l8.5 7" />,
  <path d="M5.5 9.5V20h13V9.5" />,
  <path d="M9.75 20v-5.5h4.5V20" />,
);

export const LibraryIcon = stroked(<path d="M4 4v16M9 4v16" />, <path d="m14.5 5.5 4.2 15" />);

export const PrevIcon = filled(
  <path d="M7 5a1 1 0 0 1 2 0v5.2l8.5-5.06A1 1 0 0 1 19 6v12a1 1 0 0 1-1.5.86L9 13.8V19a1 1 0 0 1-2 0V5Z" />,
);

export const NextIcon = filled(
  <path d="M17 5a1 1 0 0 0-2 0v5.2L6.5 5.14A1 1 0 0 0 5 6v12a1 1 0 0 0 1.5.86L15 13.8V19a1 1 0 0 0 2 0V5Z" />,
);

export const VideoIcon = stroked(camcorder);

export const VideoOffIcon = stroked(camcorder, <path d="M3 21 21 3" />);

export const VolumeIcon = stroked(
  speaker,
  <path d="M15.5 9.5a3.5 3.5 0 0 1 0 5" />,
  <path d="M18.5 6.5a7.5 7.5 0 0 1 0 11" />,
);

export const VolumeMuteIcon = stroked(speaker, <path d="m15.5 10 5 4M20.5 10l-5 4" />);

export const CloseIcon = stroked(<path d="M6 6l12 12M18 6 6 18" strokeWidth={2.2} />);

export const ShuffleIcon = stroked(
...
export const RepeatIcon = stroked(loop);

export const RepeatOneIcon = stroked(loop, <path d="M11.6 10.8 13 10v4.5" strokeWidth="2.2" />);
...
export const CollapseIcon = stroked(
  <path d="M20 10h-6V4M13 11l7-7" />,
  <path d="M4 14h6v6M11 13l-7 7" />,
);

export const ChevronIcon = stroked(<path d="m6 9 6 6 6-6" />);

export const SpinnerIcon = stroked(<path d="M12 3a9 9 0 1 0 9 9" strokeWidth={2.5} />);

export const PlusIcon = stroked(<path d="M12 5v14M5 12h14" />);

export const QueueAddIcon = stroked(
  <path d="M4 6h12M4 12h12M4 18h7" />,
  <path d="M17.5 14.5v6M14.5 17.5h6" />,
);

export const TrashIcon = stroked(<path d="M4 7h16M10 7V5h4v2M6 7l1 12h10l1-12" />);

export const CameraIcon = stroked(
...
export const MoreIcon = filled(
  <circle cx="5" cy="12" r="1.8" />,
  <circle cx="12" cy="12" r="1.8" />,
  <circle cx="19" cy="12" r="1.8" />,
);

export const PencilIcon = stroked(
...
export const PaletteIcon = stroked(
...
export const InfoIcon = stroked(<circle cx="12" cy="12" r="9" />, <path d="M12 11v5M12 8h.01" />);
...
export const HeartIcon = stroked(<path d={heart} />);

export const HeartFilledIcon = stroked(<path d={heart} fill="currentColor" />);

export const SpeedIcon = stroked(<path d="M3.34 19a10 10 0 1 1 17.32 0" />, <path d="m12 14 4-4" />);

export const MoonIcon = stroked(<path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9z" />);

export const PlayHereIcon = stroked(
