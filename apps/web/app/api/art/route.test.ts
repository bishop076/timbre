...
// placeholder that outlives the outage that caused it, which is exactly the shape of B-37.
...
// pin S-20 put on that host. The walk stops and the route used to call that "Host not allowed" —
