...
// The payloads that broke this: each used to pass the container check and throw
...
// Both of these are valid https, which is why the scheme alone was never the check.
