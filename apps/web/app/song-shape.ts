 ...
 * later load — first in the playlists, then again in the chart
 * cache, which is why the check lives here rather than in either store.
 *
 * **Checking the containers was not enough, and neither is checking the scheme.**
 * `artists: [1]` passed and then crashed Explore; `artworkUrl: 1` crashed every view
