...
/**
 * The choosing half of "add to playlist": the lists, a tick beside the ones already holding this
 * song, and a field to make a new one. Lifted out of the button below so the right-click menu can
 * show the same thing without a second copy of it — whoever renders it owns opening and closing.
 */
export function PlaylistPicker({
  ...
  const holding = playlistsHolding(song.id);
