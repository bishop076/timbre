...
// published and an `@mention` in it notifies a real stranger. This line was once accepted partly
...
if (failed.some((result) => result.check !== "Hash table")) {
  lines.push(
    "",
    "Listeners see this as: search's \"On Spotify\" section falling back to a connected account or saying Spotify did not answer, and pasted albums and playlists opening from their embed page or not at all.",
  );
