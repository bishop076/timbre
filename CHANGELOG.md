...
- **meta** — one mark for the README and the link card, and put the name back in it
...
- **player** — don't fight a source that is still starting the track
...
- **api** — four failure paths left behind, one of which was wrongly recorded as fixed
...
- **core** — canonicalise ISRCs, bound the art proxy, and read the queue from one place
...
- **csp** — name the host Spotify's embed loader actually fetches its player from
...
- **player** — play Spotify inside Timbre behind the album cover, in the theme's colours
...
- use public production domain for social preview images
